/**
 * 1258. Find number of odd elements in the given   ·   Easy   ·   Everyday Functions
 *
 * Write a function to find number of odd elements in the given list using
 * lambda function.
 *
 * Example 1:
 ...
 *
 * Example 2:
 *   Input:  nums = [10,15,14,13,-18,12,-20]
 *   Output: 2
 *
 * Example 3:
 *   Input:  nums = [1,2,4,8,9]
 *   Output: 2
 *
