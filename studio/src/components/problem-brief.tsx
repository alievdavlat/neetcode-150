...
import { ExternalLink, Gauge, PlayCircle, Route } from 'lucide-react';
import { ScrollArea } from '@/components/ui/scroll-area';
import { DIFFICULTY_META, STATE_META } from '@/lib/meta';
...
export function ProblemBrief({ problem, status, leetcode, video }: ProblemBriefProps) {
    ...
    <ScrollArea className="h-full">
      ...
      >
        ...
        <motion.section variants={SECTION} className="flex flex-wrap gap-2 pb-4">
          ...
          {video && renderLink(video, 'Walkthrough', <PlayCircle className="size-3.5" />)}
        </motion.section>
      </motion.article>
    </ScrollArea>
  );
